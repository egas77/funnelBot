...
ALTER TABLE public.funnel_status ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
...
INSERT INTO public."funnel_status" (id, status) VALUES (1, 'in_queue');
INSERT INTO public."funnel_status" (id, status) VALUES (2, 'dead');
INSERT INTO public."funnel_status" (id, status) VALUES (3, 'finished');

INSERT INTO public.status (id, status) VALUES (1, 'alive');
INSERT INTO public.status (id, status) VALUES (2, 'dead');
INSERT INTO public.status (id, status) VALUES (3, 'finished');
